        ...
        if accession_num in dico_exemple: 
            ...
            if nb_ex_test != 0:
                ...
                if valid_interval_ensemble != []: 
                    ...
                    list_example, example_selected_count = random_example_selection(list_example, dico_seq, valid_interval_ensemble, context_kl, context_kr,  
                                                                 context_pl, context_pr, nb_ex_test)  
                    #print("example_selected_count :", example_selected_count)
